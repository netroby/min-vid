...
const nativeWindowUtils = {  // eslint-disable-line no-unused-vars
  getNativeHandlePtrStr,
  getWindowCoords,
  getMouseInfo
};

const EXPORTED_SYMBOLS = ['nativeWindowUtils'];  // eslint-disable-line no-unused-vars
